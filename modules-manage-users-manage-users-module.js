...
var ListUsersComponent = /** @class */ (function () {
    ...
    ListUsersComponent.prototype.ngAfterViewInit = function () {
        ...
        if (this.searchForm.valid) {
            ...
            this.adminService.listUsers(pageObj).subscribe(function (res) {
                ...
                if (res.code === 200) {
                    ...
                    _this.onUsersChunk = _this.onusers.slice(0, 10);
    ...
    ListUsersComponent.prototype.paginate = function (event) {
        var obj = {
            page: event.page
        };
        this.onUsersChunk = this.onusers.slice(event.first, event.first + event.rows);
        /*  this.adminService.listUsers(obj).subscribe(res => {
           // console.log('users', res);
           if (res.code === 200) {
             this.spinner.hide();
             this.onusers = res.data.data;
             this.totalCount = res.data.totalCount;
           }
         }); */
        // this.user.listUsers(obj).subscribe(res => {
    ...
    ListUsersComponent.prototype.exportDataToCSV = function () {
        var _this = this;
        var userList = [];
    ...
    __decorate([
        ...
        __metadata("design:type", _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_7__["CdkVirtualScrollViewport"])
    ], ListUsersComponent.prototype, "virtualScroll", void 0);
...
var VideoLogComponent = /** @class */ (function () {
    function VideoLogComponent(admin, route, spinner, elRef, toaster, fb) {
        this.admin = admin;
        this.route = route;
        this.spinner = spinner;
        this.elRef = elRef;
    ...
    VideoLogComponent.prototype.superImportantQuestion = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.spinner.show();
            _this.admin.superImportant(params['id']).subscribe(function (res) {
                ...
                // tslint:disable-next-line:one-line
                {
                    ...
                    console.log('((((((((6^^^^^^^^^^^^^^^^^^^^^', _this.user1PossibleMatch);
                }
                else {
    ...
    VideoLogComponent.prototype.rankWiseListForPossibleMatch = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.admin.listRankedMatch(params['id']).subscribe(function (res) {
                console.log('age gender and super imp questions', res);
                if (res.code == 200) {
                    _this.rankedUser = res.data;
                    console.log(_this.rankedUser);
                }
    ...
    VideoLogComponent.prototype.videoCallDone = function () {
        ...
        this.route.params.subscribe(function (params) {
            console.log('params', params);
            _this.admin.videoCallDone(params['id']).subscribe(function (res) {
                ...
                // this.user1Age=res.data.age;
                // if(res.data.gender==1){
                //   this.user1Gender='Female'
                // }else if(res.data.gender==0){
                //   this.user1Gender='Male'
                // }
                // this.user1SuperImpQandA=res.data.superImpQandA
                // this.user1email= res.data.email
                // this.user1FirstName= res.data.name
                // this.user1PossibleMatch=res.data.possibleMatch
                // console.log(this.user1PossibleMatch)
            });
        });
    };
    ...
    VideoLogComponent.prototype.viewReview = function (event, userid, sessionId, overlaypanel) {
        var _this = this;
        this.route.params.subscribe(function (params) {
            ...
            _this.admin.getReview(obj).subscribe(function (res) {
                console.log(res.data, 'review data');
                _this.getReviews = res.data;
                overlaypanel.toggle(event);
                var formArr = _this.rForm.controls.add;
                _this.getReviews.forEach(function (x) {
                    console.log(x, 'formArray');
                    if (formArr.length !== 0) {
                        formArr.removeAt(0);
                        formArr.push(_this.fb.group({
                            id: x._id,
