(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["admin-admin-module~modules-manage-backgroundmusic-manage-backgroundmusic-module~modules-manage-quest~f9615d30"],{
...
var AdminService = /** @class */ (function () {
    ...
    AdminService.prototype.listOnlineUsers = function (data) {
        ...
        if (data) {
            return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].interval(10000).flatMap(function () {
                return _this.http.post(_shared_utils_eles_app_constant__WEBPACK_IMPORTED_MODULE_3__["ElesAppConst"].LIST_ONLINE_USERS, data)
                    .map(function (res) { return res; });
            });
            // return this.http.post(ElesAppConst.LIST_ONLINE_USERS, data);
        }
        else {
            return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (observer) { return observer.error(_shared_utils_string_constants__WEBPACK_IMPORTED_MODULE_4__["StringConst"].INVALID_INFORMATION); });
        }
    ...
    /*  superImportant(id): Observable<any> {
       return this.http.get(ElesAppConst.SUPER_IMPORTANT + id);
     } */
    // superImportant(id): Observable<any> {
    // return this.http.get(ElesAppConst.SUPER_IMPORTANT + id);
    // } 
    AdminService.prototype.superImportant = function (data) {
        //return this.http.get(ElesAppConst.VIDEO_CALL_DONE + id);
        if (data) {
            return this.http.post(_shared_utils_eles_app_constant__WEBPACK_IMPORTED_MODULE_3__["ElesAppConst"].SUPER_IMPORTANT, data);
        }
        else {
            return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (observer) { return observer.error(_shared_utils_string_constants__WEBPACK_IMPORTED_MODULE_4__["StringConst"].INVALID_INFORMATION); });
        }
    };
    /* listRankedMatch(id): Observable<any> {
      return this.http.get(ElesAppConst.LIST_RANKED_MATCH + id);
    } */
    AdminService.prototype.listRankedMatch = function (data) {
        //return this.http.get(ElesAppConst.VIDEO_CALL_DONE + id);
        if (data) {
            return this.http.post(_shared_utils_eles_app_constant__WEBPACK_IMPORTED_MODULE_3__["ElesAppConst"].LIST_RANKED_MATCH, data);
        }
        else {
            return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (observer) { return observer.error(_shared_utils_string_constants__WEBPACK_IMPORTED_MODULE_4__["StringConst"].INVALID_INFORMATION); });
        }
...
//# sourceMappingURL=admin-admin-module~modules-manage-backgroundmusic-manage-backgroundmusic-module~modules-manage-quest~f9615d30.js.map