...
var DisplayReportingComponent = /** @class */ (function () {
    ...
    DisplayReportingComponent.prototype.exportAsXLSXReports = function () {
        ...
        this.reports.forEach(function (element) {
            ...
            reportArr.push({
                User1: element.userInfo1.firstName,
                User1Age: element.userInfo1.age,
                User1Gender: element.userInfo1.gender ? 'Female' : 'Male',
                User2: element.userInfo2.firstName,
                User2Age: element.userInfo2.age,
                User2Gender: element.userInfo2.gender ? 'Female' : 'Male',
                matchedBasedon: element.matchedBasedon,
                Date: element.dateWithTimeZone
            });
        });
        if (reportArr.length) {
    ...
    DisplayReportingComponent.prototype.exportAsXLSXReportssortedLists = function () {
        var reportArr = [];
        this.sortedLists.forEach(function (element) {
            console.log(element, 'element');
            reportArr.push({
                User: element.userInfo.firstName,
                UserAge: element.userInfo.age,
                UserGender: element.userInfo.gender ? 'Female' : 'Male',
                questionAnswered: element.questionAnswered,
                Date: element.dateWithTimeZone
            });
        });
        if (reportArr.length) {
    ...
    DisplayReportingComponent.prototype.exportAsXLSXReportsnomatchpassUsers = function () {
        var reportArr = [];
    ...
    DisplayReportingComponent.prototype.exportAsXLSXReportsAcceptReject = function () {
        var reportArr = [];
        this.reports.forEach(function (element) {
            console.log(element, 'element');
            reportArr.push({
...
var VideodateLogsComponent = /** @class */ (function () {
    function VideodateLogsComponent(adminService, spinner) {
        this.adminService = adminService;
        this.spinner = spinner;
