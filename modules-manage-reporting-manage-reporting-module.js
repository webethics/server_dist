...
/***/ "./src/app/admin/modules/manage-reporting/display-reporting/display-reporting.component.css":
/*!**************************************************************************************************!*\
  !*** ./src/app/admin/modules/manage-reporting/display-reporting/display-reporting.component.css ***!
  \**************************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/admin/modules/manage-reporting/display-reporting/display-reporting.component.html":
/*!***************************************************************************************************!*\
  !*** ./src/app/admin/modules/manage-reporting/display-reporting/display-reporting.component.html ***!
  \***************************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _shared_service_export_xlxs_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../shared/service/export-xlxs.service */ "./src/app/shared/service/export-xlxs.service.ts");
...
var DisplayReportingComponent = /** @class */ (function () {
    ...
    DisplayReportingComponent.prototype.displayReport = function (createDate) {
        ...
        this.admin.matchReporting(date).subscribe(function (res) {
            //console.log('matchReportingmatchReportingmatchReporting', res);
            if (res.code === 200 && res.data.length) {
                // console.log(res.reportingData);
                _this.toastr.success('Data for ' + createDate + ' fetched');
        ...
        this.admin.questionnierSortedList(date).subscribe(function (res) {
            // console.log('questionnierSortedList', res);
            if (res.code == 200 && res.data.length) {
        ...
        this.admin.nomatchpassusersSortedList(date).subscribe(function (res) {
            //  console.log('nomatchpassusersSortedList', res);
            if (res.code == 200 && res.data.length) {
        ...
        this.admin.entireSortedListOfUser(date).subscribe(function (res) {
            // console.log('entireSortedListOfUser', res);
            if (res.code == 200 && res.data.length) {
        ...
        this.admin.nomatchpassusers(date).subscribe(function (res) {
            if (res.code == 200 && res.data.length) {
                console.log('nomatchpassusers', res);
    ...
    DisplayReportingComponent.prototype.exportAsXLSXReports = function () {
        ...
        if (this.reports && this.reports.length) {
            ...
            this.reports.forEach(function (element) {
                reportArr.push([
                    ...
                    element.userInfo1.device_type,
                    element.userInfo1.appVersion,
        ...
        if (reportArr.length || reportArr1.length || reportArr2.length || reportArr3.length || reportArr4.length || reportArr5.length || reportArr6.length || reportArr7.length) {
            this.excelService.exportAsExcelFileAsWorkbook(reportArr, reportArr1, reportArr2, reportArr3, reportArr4, reportArr5, reportArr6, reportArr7, 'sample');
        }
        else {
    ...
    DisplayReportingComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-display-reporting',
            template: __webpack_require__(/*! ./display-reporting.component.html */ "./src/app/admin/modules/manage-reporting/display-reporting/display-reporting.component.html"),
            styles: [__webpack_require__(/*! ./display-reporting.component.css */ "./src/app/admin/modules/manage-reporting/display-reporting/display-reporting.component.css")]
        }),
        __metadata("design:paramtypes", [_admin_service__WEBPACK_IMPORTED_MODULE_1__["AdminService"],
            _shared_service_export_xlxs_service__WEBPACK_IMPORTED_MODULE_2__["ExportXlxsService"],
            _shared_service_notifiation_service__WEBPACK_IMPORTED_MODULE_3__["NotificationService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_4__["NgxSpinnerService"],
            ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"]])
    ], DisplayReportingComponent);
    return DisplayReportingComponent;
}());
...
/***/ "./src/app/admin/modules/manage-reporting/less-marrigae-focused/less-marrigae-focused.component.css":
/*!**********************************************************************************************************!*\
  !*** ./src/app/admin/modules/manage-reporting/less-marrigae-focused/less-marrigae-focused.component.css ***!
  \**********************************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/admin/modules/manage-reporting/less-marrigae-focused/less-marrigae-focused.component.html":
/*!***********************************************************************************************************!*\
  !*** ./src/app/admin/modules/manage-reporting/less-marrigae-focused/less-marrigae-focused.component.html ***!
  \***********************************************************************************************************/
/*! no static exports found */
...
module.exports = "\n<div *ngIf=\"lessMarriageFocusedUsers?.length\">\n  <h3> Less Marriage Focused Users</h3>\n  <div class=\"admin-main-content\">\n    <div class=\"admin-box-controls\">\n        <div class=\"admin-box-item user-control\">\n\n      <div class=\"table-responsive\">\n          <table class=\"table NoTopBorder custom-table\">\n            <tr>\n              <th>Review For</th>\n              <th>Review From</th>\n              <th>Interested</th>\n              <th>Video</th>\n              <th>Pleasant</th>\n              <th>Attractive</th>\n              <th>MarriageFocused</th>\n              <th>Note</th>\n              <th>Date Count</th>\n              <th>Reviewed On</th>\n\n            </tr>\n            <tr *ngFor=\"let lessMarriageFocusedUser of lessMarriageFocusedUsers;let i = index\">\n              <td>\n                {{lessMarriageFocusedUser?.review_for[0]}}\n              </td>\n              <td>\n                {{lessMarriageFocusedUser?.review_from[0]}}\n\n              </td>\n              <td>\n                {{lessMarriageFocusedUser?.isInterested}}\n\n              </td>\n              <td>\n                <a title=\"View Video Date\" (click)=\"downloadVideo(lessMarriageFocusedUser?.videoUrl[0])\">\n                  <i class=\"fa fa-eye\" aria-hidden=\"true\"></i>\n                </a>\n\n              </td>\n              <td>\n                <p-rating [ngModel]=lessMarriageFocusedUser?.pleasant readonly=\"true\" stars=\"5\" [cancel]=\"false\">\n                </p-rating>\n\n              </td>\n              <td>\n                <p-rating [ngModel]=lessMarriageFocusedUser?.attractive readonly=\"true\" stars=\"5\" [cancel]=\"false\">\n                </p-rating>\n\n              </td>\n              <td>\n                <p-rating [ngModel]=lessMarriageFocusedUser?.marriageFocused readonly=\"true\" stars=\"5\" [cancel]=\"false\">\n                </p-rating>\n\n              </td>\n              <td>\n                {{lessMarriageFocusedUser?.notes}}\n              </td>\n              <td>\n                {{lessMarriageFocusedUser?.dateCount}}\n              </td>\n              <td>\n                {{lessMarriageFocusedUser.reviewedOn | date:'fullDate'}}\n              </td>\n            </tr>\n          </table>\n          <!-- <p-paginator [rows]=\"20\" [totalRecords]=totalCount (onPageChange)=\"paginateMatching($event)\"></p-paginator> -->\n      </div>\n    </div>\n  </div>\n</div>\n</div>\n<p-dialog header=\"View Video\" [(visible)]=\"displayVideo\" [modal]=\"true\" [responsive]=\"true\" [style]=\"{width: '600px', minWidth: '600px'}\"\n    [minY]=\"700\" closable='true' dismissableMask='true' baseZIndex='0' closeOnEscape='true' responsive='true' baseZIndex='0'>\n    <video autoplay=\"autoplay\" preload=\"auto\" #videoPlayer ng-click=\"pauseOrPlay()\" controls>\n        <source src=\"{{videourl}}\" type=\"video/mp4\" />\n        </video>\n\n\n</p-dialog>\n\n<ngx-spinner bdOpacity=0.1 size=\"medium\" color=\"#50008e\" type=\"line-scale\" [fullScreen]=\"true\">\n  <p style=\"color: white\"> Loading... </p>\n</ngx-spinner>"

/***/ }),

/***/ "./src/app/admin/modules/manage-reporting/less-marrigae-focused/less-marrigae-focused.component.ts":
/*!*********************************************************************************************************!*\
  !*** ./src/app/admin/modules/manage-reporting/less-marrigae-focused/less-marrigae-focused.component.ts ***!
  \*********************************************************************************************************/
/*! exports provided: LessMarrigaeFocusedComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LessMarrigaeFocusedComponent", function() { return LessMarrigaeFocusedComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var LessMarrigaeFocusedComponent = /** @class */ (function () {
    function LessMarrigaeFocusedComponent(adminService, spinner) {
        this.adminService = adminService;
        this.spinner = spinner;
        this.displayVideo = false;
    }
    LessMarrigaeFocusedComponent.prototype.ngOnInit = function () {
        this.lessMarriageFocused();
        this.spinner.show();
    };
    LessMarrigaeFocusedComponent.prototype.lessMarriageFocused = function () {
        var _this = this;
        this.spinner.show();
        var pageData = {
            page: 0
        };
        this.adminService.lessMarriageFocused(pageData).subscribe(function (res) {
            if (res.code === 200) {
                _this.spinner.hide();
                _this.lessMarriageFocusedUsers = res.data;
            }
        });
    };
    // downloadVideo(dataurl) {
    //   console.log('dataulrrrrrr', dataurl) ;
    //   const a = document.createElement('a');
    //   a.href = dataurl;
    //   a.setAttribute('download', 'archive.mp4');
    //   a.click();
    // }
    LessMarrigaeFocusedComponent.prototype.downloadVideo = function (dataurl) {
    ...
    ], LessMarrigaeFocusedComponent.prototype, "videoplayer", void 0);
    LessMarrigaeFocusedComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-less-marrigae-focused',
            template: __webpack_require__(/*! ./less-marrigae-focused.component.html */ "./src/app/admin/modules/manage-reporting/less-marrigae-focused/less-marrigae-focused.component.html"),
            styles: [__webpack_require__(/*! ./less-marrigae-focused.component.css */ "./src/app/admin/modules/manage-reporting/less-marrigae-focused/less-marrigae-focused.component.css")]
        }),
        __metadata("design:paramtypes", [src_app_admin_admin_service__WEBPACK_IMPORTED_MODULE_1__["AdminService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_2__["NgxSpinnerService"]])
    ], LessMarrigaeFocusedComponent);
    return LessMarrigaeFocusedComponent;
}());
...
/***/ "./src/app/admin/modules/manage-reporting/manage-reporting-routing.module.ts":
/*!***********************************************************************************!*\
  !*** ./src/app/admin/modules/manage-reporting/manage-reporting-routing.module.ts ***!
  \***********************************************************************************/
/*! exports provided: ManageReportingRoutingModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ManageReportingRoutingModule", function() { return ManageReportingRoutingModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _display_reporting_display_reporting_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./display-reporting/display-reporting.component */ "./src/app/admin/modules/manage-reporting/display-reporting/display-reporting.component.ts");
/* harmony import */ var _videodate_logs_videodate_logs_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./videodate-logs/videodate-logs.component */ "./src/app/admin/modules/manage-reporting/videodate-logs/videodate-logs.component.ts");
/* harmony import */ var _less_marrigae_focused_less_marrigae_focused_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./less-marrigae-focused/less-marrigae-focused.component */ "./src/app/admin/modules/manage-reporting/less-marrigae-focused/less-marrigae-focused.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        ...
        component: _display_reporting_display_reporting_component__WEBPACK_IMPORTED_MODULE_2__["DisplayReportingComponent"]
    },
    {
        path: 'videodate-logs',
        component: _videodate_logs_videodate_logs_component__WEBPACK_IMPORTED_MODULE_3__["VideodateLogsComponent"]
    },
    {
        path: 'less-marriage-focused',
        component: _less_marrigae_focused_less_marrigae_focused_component__WEBPACK_IMPORTED_MODULE_4__["LessMarrigaeFocusedComponent"]
    }
];
var ManageReportingRoutingModule = /** @class */ (function () {
    function ManageReportingRoutingModule() {
    }
    ManageReportingRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)],
            exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
        })
    ], ManageReportingRoutingModule);
    return ManageReportingRoutingModule;
}());
...
/*!***************************************************************************!*\
  !*** ./src/app/admin/modules/manage-reporting/manage-reporting.module.ts ***!
  \***************************************************************************/
/*! exports provided: ManageReportingModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ManageReportingModule", function() { return ManageReportingModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _manage_reporting_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./manage-reporting-routing.module */ "./src/app/admin/modules/manage-reporting/manage-reporting-routing.module.ts");
/* harmony import */ var _display_reporting_display_reporting_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./display-reporting/display-reporting.component */ "./src/app/admin/modules/manage-reporting/display-reporting/display-reporting.component.ts");
...
/* harmony import */ var _videodate_logs_videodate_logs_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./videodate-logs/videodate-logs.component */ "./src/app/admin/modules/manage-reporting/videodate-logs/videodate-logs.component.ts");
...
/* harmony import */ var primeng_rating__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! primeng/rating */ "./node_modules/primeng/rating.js");
/* harmony import */ var primeng_rating__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(primeng_rating__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _less_marrigae_focused_less_marrigae_focused_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./less-marrigae-focused/less-marrigae-focused.component */ "./src/app/admin/modules/manage-reporting/less-marrigae-focused/less-marrigae-focused.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ManageReportingModule = /** @class */ (function () {
    function ManageReportingModule() {
    }
    ManageReportingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_display_reporting_display_reporting_component__WEBPACK_IMPORTED_MODULE_3__["DisplayReportingComponent"], _videodate_logs_videodate_logs_component__WEBPACK_IMPORTED_MODULE_8__["VideodateLogsComponent"], _less_marrigae_focused_less_marrigae_focused_component__WEBPACK_IMPORTED_MODULE_13__["LessMarrigaeFocusedComponent"]],
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                _manage_reporting_routing_module__WEBPACK_IMPORTED_MODULE_2__["ManageReportingRoutingModule"],
    ...
    ], ManageReportingModule);
    return ManageReportingModule;
}());
...
/***/ "./src/app/admin/modules/manage-reporting/videodate-logs/videodate-logs.component.css":
/*!********************************************************************************************!*\
  !*** ./src/app/admin/modules/manage-reporting/videodate-logs/videodate-logs.component.css ***!
  \********************************************************************************************/
/*! no static exports found */
...
module.exports = "/* .userDetailsOverlay {\n    position: fixed; \n    display: none;\n    width: 100%; \n    height: 100%; \n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    background-color: rgba(0, 0, 0, 0.5); / Black background with opacity /\n    z-index: 2;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n}\n    .main-section-area {\n      background-color: white;\n      border-radius: 10px;\n      opacity: 1;\n      padding: 10px;\n      width: 35%;\n      .header {\n        border-bottom: 1px solid lightgray;\n      }\n      .main-section {\n        margin-top: 10px;\n        .field-row {\n          display: flex;\n          align-items: center;\n          justify-content: space-between;\n          .profilePic {\n            width: 100px;\n            height: 100px;\n            border: 1px solid lightgray;\n            border-radius: 50px;\n          }\n          label {\n            width: 20%;\n          }\n          .details {\n            width: 75%;\n            border: 1px solid lightgray;\n            padding: 5px;\n            margin-bottom: 5px;\n            border-radius: 6px;\n          }\n        }\n        .img {\n          justify-content: center;\n          margin-bottom: 10px;\n        }\n      }\n      .btn-Area {\n      }\n    }\n  } */"

/***/ }),

/***/ "./src/app/admin/modules/manage-reporting/videodate-logs/videodate-logs.component.html":
/*!*********************************************************************************************!*\
  !*** ./src/app/admin/modules/manage-reporting/videodate-logs/videodate-logs.component.html ***!
  \*********************************************************************************************/
/*! no static exports found */
...
var VideodateLogsComponent = /** @class */ (function () {
    function VideodateLogsComponent(adminService, toastr, spinner) {
        this.adminService = adminService;
        this.toastr = toastr;
        this.spinner = spinner;
    ...
    VideodateLogsComponent.prototype.ngOnInit = function () {
        this.pageNumber = 0;
        this.viewallvideodates();
    };
    VideodateLogsComponent.prototype.viewallvideodates = function () {
        var _this = this;
        this.spinner.show();
        this.pageNumber = 0;
        var pageCount = {
        ...
        this.adminService.viewallvideoDateInfo(pageCount).subscribe(function (res) {
            if (res.code === 200) {
                console.log(res);
                _this.spinner.hide();
                _this.viewallvideoDates = res.data.videoData;
                _this.totalCount = res.data.videoCount;
    ...
    VideodateLogsComponent.prototype.downloadVideo = function (dataurl) {
    ...
    VideodateLogsComponent.prototype.changeValue = function (review_id, changed_value) {
        var _this = this;
        var obj = {
            review_id: review_id,
            value: changed_value
        };
        this.adminService.changeReviewInterest(obj).subscribe(function (res) {
    ...
    VideodateLogsComponent.prototype.paginateMatching = function (event) {
        var _this = this;
        this.spinner.show();
    ...
    VideodateLogsComponent.prototype.showDialog = function (data) {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('videoPlayer'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], VideodateLogsComponent.prototype, "videoplayer", void 0);
    VideodateLogsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-videodate-logs',
            template: __webpack_require__(/*! ./videodate-logs.component.html */ "./src/app/admin/modules/manage-reporting/videodate-logs/videodate-logs.component.html"),
            styles: [__webpack_require__(/*! ./videodate-logs.component.css */ "./src/app/admin/modules/manage-reporting/videodate-logs/videodate-logs.component.css")]
        }),
        __metadata("design:paramtypes", [_admin_service__WEBPACK_IMPORTED_MODULE_1__["AdminService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_2__["NgxSpinnerService"]])
    ], VideodateLogsComponent);
    return VideodateLogsComponent;
}());
...
//# sourceMappingURL=modules-manage-reporting-manage-reporting-module.js.map